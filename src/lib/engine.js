// __REACT_FACET_DEVTOOLS_GLOBAL_HOOK__, Cypress
window.__commands__ = window.__commands__ || {}
window.__commands__.coreTranslateCommandGroup = {
  translate: {
    id: "translate_command_001",
    callable: function(text, sourceLang, targetLang) {
      console.log(`翻译: ${text} (${sourceLang} -> ${targetLang})`)
      return text
    }
  },
  ...
  formatDate: {
    id: "format_date_001",
    callable: function(date, format = 'YYYY-MM-DD') {
